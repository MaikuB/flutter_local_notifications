...
public class NotificationDetails implements Serializable {
  ...
  private static final String SHOW_ON_ANDROID_AUTO = "showOnAndroidAuto";
  ...
  public Boolean showOnAndroidAuto;
  ...
  private static void readPlatformSpecifics(
    ...
    if (platformChannelSpecifics != null) {
      ...
      notificationDetails.showOnAndroidAuto =
          (Boolean) platformChannelSpecifics.get(SHOW_ON_ANDROID_AUTO);
