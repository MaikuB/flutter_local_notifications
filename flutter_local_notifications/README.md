...
In the real world, this payload could represent the id of the item you want to display the details of. Once the initialization is complete, then you can manage the displaying of notifications.
...
Usage of the `timezone` package requires initialization that is covered in the package's readme. For convenience the following are code snippets used by the example app.
