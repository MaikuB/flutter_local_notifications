...
* [iOS 12.0+ and macOS 10.14+] Support for custom notification settings UI via "Configure Notifications in <application name>" button in notification context menu
