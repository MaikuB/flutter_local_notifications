...
class AndroidNotificationDetails {
  ...
  /// piece of state at a glance, e.g. `"3 min"` or `"2.1 mi"`. Around seven
  /// characters are shown. It only has an effect when the notification is
  /// promoted (see [requestPromotedOngoing]) and is ignored on older versions
  /// of Android.
