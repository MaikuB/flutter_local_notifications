...
class ProgressStyleSegment {
  ...
  const ProgressStyleSegment(
    this.length, {
    this.id,
    this.color,
    this.semanticStyle = SemanticStyle.unspecified,
  });
...
/// which may be bookended by [progressStartIcon] and [progressEndIcon]. It is
/// one of the styles a notification may use to be promoted as a Live Update;
/// see [AndroidNotificationDetails.requestPromotedOngoing]. It is ignored on
