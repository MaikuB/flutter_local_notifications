...
# [iOS][macOS] Added the ability to request provisional permissions. Thanks to the PR from [Tokenyet](https://github.com/MaikuB/flutter_local_notifications/pull/2022)
