...
part 'src/platform_specifics/android/styles/messaging_style_information.dart';
...
part 'src/platform_specifics/android/message.dart';
part 'src/platform_specifics/android/person.dart';
